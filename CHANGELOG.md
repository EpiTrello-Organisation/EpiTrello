...
## [1.1.0](https://github.com/EpiTrello-Organisation/EpiTrello/compare/v1.0.0...v1.1.0) (2026-02-10)
...
* **changebackground:** implement feature and its tests ([e4dd2f6](https://github.com/EpiTrello-Organisation/EpiTrello/commit/e4dd2f6741ce6f424c5972f2c60d3f580a08505d))
...
* **members:** add members display on card ([af11cb7](https://github.com/EpiTrello-Organisation/EpiTrello/commit/af11cb7e27a806d9255578f61ccee1804d00042c))
...
* **backend:** fix warnings ([bf9a9e4](https://github.com/EpiTrello-Organisation/EpiTrello/commit/bf9a9e437ee4731784a1b1a87d632972b4dc0d96))
...
* **errors:** fix warnings ([0304e33](https://github.com/EpiTrello-Organisation/EpiTrello/commit/0304e33bca81b25d322394a568ec43b01a6d72ae))
...
* **main:** release 0.2.0 ([3ba3bf2](https://github.com/EpiTrello-Organisation/EpiTrello/commit/3ba3bf234f56de301713021da4c3b94601cab954))
* **main:** release 0.2.0 ([a6a71d0](https://github.com/EpiTrello-Organisation/EpiTrello/commit/a6a71d05201b60a3d2c7d07cdd36524cadb2313a))
* **main:** release 0.3.0 ([6d55d24](https://github.com/EpiTrello-Organisation/EpiTrello/commit/6d55d246d9a53702e469d7de6c205974f9974c70))
* **main:** release 0.3.0 ([acbdfc5](https://github.com/EpiTrello-Organisation/EpiTrello/commit/acbdfc5649e0a0a0afe3309098ea3eb5f032b7ac))
* **main:** release 0.3.1 ([266c6d0](https://github.com/EpiTrello-Organisation/EpiTrello/commit/266c6d03b908996218b9389ede699496eaff5e2f))
* **main:** release 0.3.1 ([d132d3a](https://github.com/EpiTrello-Organisation/EpiTrello/commit/d132d3a6f9a4dd6f8ab404326c0b204985ee640e))
...
* **release:** 1.0.0 ([86dae88](https://github.com/EpiTrello-Organisation/EpiTrello/commit/86dae889553013572ed31eb01d894f35c2b5bdb3))
...
* **boards:** increase boards title weight ([7caa3e9](https://github.com/EpiTrello-Organisation/EpiTrello/commit/7caa3e92bc1fe653bd7b94f9f5d2e76b563f3ae8))
* **card:** add padding between last card and add card button to match listcomposer height ([cfc0715](https://github.com/EpiTrello-Organisation/EpiTrello/commit/cfc0715c2981b954e0cfa42a0f908f3ecbdace51))
* **login:** improve design to match Trello ([7e72b2e](https://github.com/EpiTrello-Organisation/EpiTrello/commit/7e72b2eb81183cecf24a7a4e7a2ba5ff28225127))
* **otherboards:** add a message or empty other boards list ([5007f6f](https://github.com/EpiTrello-Organisation/EpiTrello/commit/5007f6fd7b6092c098fa8d46303e0e27ed0839df))
...
* **signup:** improve design to match Trello ([40acc12](https://github.com/EpiTrello-Organisation/EpiTrello/commit/40acc12a1be9ad55c2413f73915016ffedab1338))
